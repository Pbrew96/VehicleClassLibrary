...
namespace VehicleClassLibrary.Models
{
    public class CarModel : VehicleModel
    {
        ...
        public CarModel(int id, string make, string model, int year, decimal price, int numWheels, bool isConvertible, decimal trunkSize) : base(id, make, model, year, price, numWheels)
        {
