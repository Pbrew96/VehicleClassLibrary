...
static void ControlLoop()
{
    ...
    //Declare and intialize other variables
    int choice = -1, id = 0, year = 0, numWheels = 0;
    string make = "", model = "", color = "";
    decimal price = 0m, total = 0m;

    // Specialty vehicle variables
    bool isConvertible = false, hasSideCar = false, hasBedCover = false, isNew = false;
    ...
    while (choice != 0)
    {
        ...
        switch (choice)
        {
            ...
            case 3:
                ...
                // Read if the vehicle is new
                isNew = ReadBool("Is the vehicle new? (true/false): ");
                ...
                switch (choice)
                {
                    ...
                    case 1:
                        ...
                        // Create a new car
                        vehicle = new CarModel(id, make, model, year, price, numWheels, color, isNew, isConvertible, trunkSize);
                        break;
                    ...
                    case 2:
                        ...
                        vehicle = new MotorcycleModel(id, make, model, year, price, numWheels, color, isNew, hasSideCar, seatHeight);
                        break;
                    ...
                    case 3:
                        ...
                        // Create a new pickup
                        vehicle = new PickupModel(id, make, model, year, price, numWheels, color, isNew, hasBedCover, bedSize);
                        break;
                    ...
                    default:
                        ...
                        vehicle = new VehicleModel(id, make, model, year, price, numWheels, color, isNew);
                        break;
                }
            ...
            case 4:
                ...
                id = ReadInt("Enter the id of the vehicle you want to buy: ");
